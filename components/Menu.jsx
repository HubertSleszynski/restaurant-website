...
const Menu = () => {
  return (
    <section className="telative py-12 xl:py-24 bg-menu" id="menu">
      <div className="container mx-auto">
        ...
        >
          ...
          >
            View all <IoIosArrowRoundForward className="text-3xl" />
          </Link>
        </motion.div>
        <motion.div
        ...
        >
          {menu.map((item, index) => {
            return (
              <div
                key={index}
                className="max-w-[270px] bg-white shadow-primary mx-auto xl:mx-0 group hover:cursor-pointer"
              >
                ...
                <div className="pt-[26px] pb-[28px] px-[30px]">
                  <Link href="/">
